...
const navigationSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Income Settings', href: '/help/features/income' },
      { label: 'Reports', href: '/help/features/reports' },
      { label: 'Advanced Features', href: '/help/features/advanced' },
    ],
  },
  {
    label: 'Tutorials',
    ...
    items: [
      ...
      { label: 'Tracking Debt Payoff', href: '/help/tutorials/debt-payoff' },
      { label: 'Auto-Categorization', href: '/help/tutorials/auto-categorization' },
      { label: 'Using Smart Allocation', href: '/help/tutorials/smart-allocation' },
      { label: 'Building an Emergency Fund', href: '/help/tutorials/emergency-fund' },
    ],
  },
  {
    label: 'Wizards',
    ...
    items: [
      ...
      { label: 'Income Setup Wizard', href: '/help/wizards/income-setup' },
      { label: 'Category Types Wizard', href: '/help/wizards/category-types' },
      { label: 'Smart Allocation Wizard', href: '/help/wizards/smart-allocation' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Transactions & Categories', href: '/help/faq/transactions' },
      { label: 'Money Movement', href: '/help/faq/money-movement' },
      { label: 'Import & Export', href: '/help/faq/import-export' },
