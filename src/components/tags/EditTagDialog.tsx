...
interface EditTagDialogProps {
  ...
  onClose: () => void;
  tag: TagWithStats;
  onSuccess: (tagId: number, updates: Partial<TagWithStats>) => void;
}
...
export default function EditTagDialog({ isOpen, onClose, tag, onSuccess }: EditTagDialogProps) {
  ...
  useEffect(() => {
    if (tag) {
      ...
      setSelectedColor(tag.color || null);
    }
  }, [tag]);
