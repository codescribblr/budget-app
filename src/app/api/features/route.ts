...
const FEATURES = {
  ...
  ai_onboarding: {
    ...
    description: 'Adaptive first-run setup that asks about your situation, suggests envelopes and amounts, and creates your starter budget step by step. Available without Premium for easier new-user setup.',
    level: 'basic',
    dependencies: [],
    dataLossWarning: false,
    requiresPremium: false,
